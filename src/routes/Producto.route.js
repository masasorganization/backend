...
router.get('/listarporCategoria/:id', Auth.verificarToken, ProductoCtrl.porCategoria)
...
router.get('/buscar/:nombres', Auth.verificarToken, ProductoCtrl.buscarProducto)
